...
public class PanelTimingTileEnts extends JPanelMsgHandler implements ITabPanel {
    ...
    private final JButtonAccess btnReset;
    ...
    public boolean handleMessage(Message msg, PacketBase rawdata) {
        switch (msg) {
            case LIST_TIMING_TILEENTS: {
                ...
                rawdata.array.stream().map((o) -> (DataBlockTileEntity) o).forEachOrdered((data) -> {
            ...
            case CLIENT_HIGHLIGHT_BLOCK: {
                OpisMod.selectedBlock = (CoordinatesBlock) rawdata.value;
